...
import '../../features/tabs/search/data/api/search_api_manager.dart' as _i21;
...
import '../../features/tabs/search/domain/repository/search_repository.dart'
    as _i24;
import '../../features/tabs/search/domain/usecases/search_usecase.dart' as _i26;
import '../../features/tabs/search/ui/cubit/search_view_model.dart' as _i27;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i14.PopularMoviesDataSource>(
        () => _i15.PopularMoviesDataSourceImpl(gh<_i5.ApiManager>()));
    ...
    gh.singleton<_i21.SearchApimanager>(
        () => _i21.SearchApimanager(gh<_i3.ApiConsumer>()));
    gh.factory<_i22.SearchDataSource>(
        () => _i23.SearchDataSourceImpl(gh<_i21.SearchApimanager>()));
    gh.factory<_i24.SearchRepository>(
        () => _i25.SearchRepositoryImpl(gh<_i22.SearchDataSource>()));
    gh.factory<_i26.SearchUseCase>(
        () => _i26.SearchUseCase(gh<_i24.SearchRepository>()));
    gh.factory<_i27.SearchViewModel>(
        () => _i27.SearchViewModel(gh<_i26.SearchUseCase>()));
    gh.factory<_i28.SimilarMoviesOnlineDataSource>(() =>
        _i29.SimilarMoviesOnlineDataSourceImpl(
            gh<_i7.MovieDetailsFeatureApiManager>()));
    gh.factory<_i30.SimilarMoviesRepository>(() =>
        _i31.SimilarMoviesRepositoryImpl(
            gh<_i28.SimilarMoviesOnlineDataSource>()));
    gh.factory<_i32.SimilarMoviesUseCase>(
        () => _i32.SimilarMoviesUseCase(gh<_i30.SimilarMoviesRepository>()));
    gh.factory<_i33.SimilarMoviesViewModel>(
        () => _i33.SimilarMoviesViewModel(gh<_i32.SimilarMoviesUseCase>()));
    gh.factory<_i34.TopRatedMoviesDataSource>(
        () => _i35.TopRatedMoviesDataSourceImpl(gh<_i5.ApiManager>()));
    gh.factory<_i36.TopRatedMoviesRepository>(() =>
        _i37.TopRatedMoviesRepositoryImpl(gh<_i34.TopRatedMoviesDataSource>()));
    gh.factory<_i38.TopRatedMoviesUseCase>(
        () => _i38.TopRatedMoviesUseCase(gh<_i36.TopRatedMoviesRepository>()));
    gh.factory<_i39.TopRatedViewModel>(
        () => _i39.TopRatedViewModel(gh<_i38.TopRatedMoviesUseCase>()));
    gh.factory<_i40.UpCommingMoviesDataSource>(
        () => _i41.UpCommingMoviesDataSourceImpl(gh<_i5.ApiManager>()));
    gh.factory<_i42.UpCommingMoviesRepository>(() =>
        _i43.UpCommingMoviesRepositoryImpl(
            gh<_i40.UpCommingMoviesDataSource>()));
    gh.factory<_i44.UpCommingMoviesUseCase>(() =>
        _i44.UpCommingMoviesUseCase(gh<_i42.UpCommingMoviesRepository>()));
    gh.factory<_i45.UpCommingMoviesViewModel>(
        () => _i45.UpCommingMoviesViewModel(gh<_i44.UpCommingMoviesUseCase>()));
    return this;
  }
}
